                    ...
                    <div class="faq-item">
                        ...
                        <div class="answer">
                            <p><br>We focus on areas where clinical evidence indicates a need to reduce risk and improve patient care, such as:<br>• Improve Patient Satisfaction – Press Ganey<br>• Support the hospitals strategy to contain Average Length
                                of Stay (ALOS)<br>• Timely integration of data to EMR and other internal core Systems<br>• Meet the stringent emerging government and state requirements<br>• Provide the appropriate and timely mandatory reporting as needed,
                                including accreditation surveys<br>Our Medical Equipment Management System (MEMS) is designed to manage and integrate all inventory and maintenance/calibration tasks associated with any piece of equipment a hospital may
                                have, even across large IDN’s. Some of the key benefits of MEMS are:<br><br></p>
                        </div>
                    </div>
                </div>
            </div>
